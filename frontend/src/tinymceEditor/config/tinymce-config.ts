...
// function setupCustomFeatures(editor: any) {
//   // 見出しボタン
...
//     text: "重要",
//     onAction: () => editor.formatter.apply("important"),
//   });

//   editor.ui.registry.addButton("action-item", {
//     text: "アクション",
//     onAction: () => editor.formatter.apply("action-item"),
//   });

//   // フォーマッターの登録
//   editor.formatter.register("important", {
//     inline: "span",
//     classes: "important",
//   });

//   editor.formatter.register("action-item", {
//     inline: "span",
//     classes: "action-item",
//   });
...
//   editor.addShortcut("meta+shift+h", "Heading", () => {
//     editor.execCommand("FormatBlock", false, "h1");
//   });

//   // カスタムコンテキストメニュー
//   editor.ui.registry.addContextMenu("custommenu", {
...
//           text: "重要",
//           onAction: function () {
//             editor.formatter.apply("important");
//           },
//         },
//         {
//           type: "item",
//           text: "アクションアイテム",
//           onAction: function () {
//             editor.formatter.apply("action-item");
//           },
//         },
//       ];
//     },
