#!/usr/bin/env python3
"""
test_page1.html専用テスト
test_page1.htmlのスクレイピング機能をテストします
"""
...
from backend.app.models.scraping_schemas import ScrapingRequest, ScrapingResult
from backend.app.config.settings import get_settings

async def test_page1_only():
    """test_page1.html専用テスト"""
    print("=" * 60)
    print("HTMLEditer test_page1.html専用テスト")
    print("=" * 60)
    ...
    try:
        ...
        # テスト用のリクエストを作成
        test_url = "http://localhost:8080/test_page1.html"
...
if __name__ == "__main__":
    # テストサーバーが起動しているか確認
    print("🚀 test_page1.html専用テストを開始します...")
    
    # 非同期テストを実行
    success = asyncio.run(test_page1_only())
