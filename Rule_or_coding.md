...
- The AI's internal thought process must be in **English**. All communication between AIs, external responses, and documentation must be in **Japanese**.
...
- Upon agent startup, read the entirety of `cursor.md` and display all top-level principles in the chat.
